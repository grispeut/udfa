...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
                    bbox_targets, bbox_weights, num_total_samples, return_only_fm=False):
        ...
        loss_cls = self.loss_cls(
            cls_score, labels, label_weights, avg_factor=num_total_samples, return_only_fm=return_only_fm)
        # regression loss

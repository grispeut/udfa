...
class TwoStageDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 adv_cfg=None,
                 pretrained=None):
        super(TwoStageDetector, self).__init__(adv_cfg)
    ...
    def extract_feat(self, img, return_fm=False):
    ...
    def forward_train(self,
        ...
        if self.with_rpn:
            proposal_cfg = self.train_cfg.get('rpn_proposal',
                                              self.test_cfg.rpn)
            if return_only_fm:
                neck_mask_batch, bb_mask_batch, losses_cls, cls_score = self.rpn_head.forward_train(
                    x,
                    img_metas,
                    gt_bboxes,
                    gt_labels=None,
                ...
                rpn_losses, proposal_list, neck_mask_batch, bb_mask_batch = self.rpn_head.forward_train(
                    x,
                    img_metas,
                    gt_bboxes,
                    gt_labels=None,
